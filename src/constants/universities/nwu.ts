...
export const NWU_FACULTIES: Faculty[] = [
  ...
  },
  {
    ...
    degrees: [
      {
        id: createDegreeId(
          "Bachelor of Arts Public Governance Public Administration NWU",
        ),
      ...
      {
        id: createDegreeId(
          "Bachelor of Arts Public Governance Municipal Management NWU",
        ),
        name: "Bachelor of Arts (BA) in Public Governance (with Municipal Management and Leadership)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 25,
        description: "Municipal management and leadership",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 3, isRequired: true },
        ],
      ...
      {
        id: createDegreeId(
          "Bachelor of Arts Public Governance Policing Practice NWU",
        ),
        name: "Bachelor of Arts (BA) in Public Governance (with Policing Practice)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 25,
        description: "Policing practice and law enforcement",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Life Orientation", level: 3, isRequired: false },
        ],
      ...
      {
        id: createDegreeId(
          "Bachelor of Social Sciences Political Studies International Relations NWU",
        ),
      ...
      {
        id: createDegreeId(
          "Bachelor of Administration Development Management Local Government NWU",
        ),
      ...
      {
        id: createDegreeId(
          "Extended Bachelor of Administration Development Management Local Government NWU",
        ),
      ...
      {
        id: createDegreeId("Bachelor of Arts Communication NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Graphic Design NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Graphic Design Communication NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Language Literary Studies NWU"),
        ...
        careerProspects: ["Language Teacher", "Translator", "Writer"],
      },
      {
        id: createDegreeId("Bachelor of Arts Language Technology NWU"),
      ...
      },
      {
        ...
        duration: "3 years",
        apsRequirement: 18,
        description: "Musical performance and theory",
        subjects: [
          { name: "English", level: 4, isRequired: true },
      ...
      {
        id: createDegreeId("Bachelor of Arts Music Society NWU"),
      ...
      {
        id: createDegreeId("Baccalaureus Musicae BMus NWU"),
      ...
      {
        id: createDegreeId(
          "Bachelor of Philosophy BPhil Philosophy Politics Economics NWU",
        ),
        name: "Bachelor of Philosophy (BPhil) (with Philosophy, Politics and Economics)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 26,
        description: "Philosophy, politics, and economics combination",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 4, isRequired: true },
        ],
        careerProspects: ["Policy Analyst", "Researcher", "Consultant"],
      },
      {
        id: createDegreeId("Bachelor of Arts Humanities Afrikaans Dutch NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Humanities English NWU"),
        name: "Bachelor of Arts (BA) Humanities (with English)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 24,
        description: "Humanities with English focus",
        subjects: [{ name: "English", level: 5, isRequired: true }],
        careerProspects: ["English Teacher", "Writer", "Editor"],
      },
      {
        id: createDegreeId("Bachelor of Arts Humanities Setswana NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Humanities Sesotho NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Humanities Social Sciences NWU"),
        name: "Bachelor of Arts (BA) Humanities (with Social Sciences)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 24,
        description: "Humanities with various social science combinations",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "History", level: 3, isRequired: false },
        ],
      ...
      {
        id: createDegreeId("Bachelor of Social Sciences BSocSc General NWU"),
        name: "Bachelor of Social Sciences (BSocSc)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 22,
        description: "General social sciences with various specializations",
        subjects: [
          { name: "English", level: 4, isRequired: true },
      ...
      {
        id: createDegreeId("Bachelor of Social Sciences Economics NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Arts Sociology Geography NWU"),
        name: "Bachelor of Arts (BA) (with Sociology and Geography, with Sociology and Labour Relations Management)",
        faculty: "Humanities",
        duration: "3 years",
        apsRequirement: 22,
        description: "Arts with sociology combinations",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Geography", level: 3, isRequired: false },
        ],
      ...
      {
        id: createDegreeId(
          "Bachelor of Arts Behavioural Sciences Sociology Psychology NWU",
        ),
  ...
  },
  {
    ...
    degrees: [
      {
        id: createDegreeId("Bachelor of Arts Law Psychology NWU"),
        name: "Bachelor of Arts in Law (BA in Law) (with Psychology)",
        faculty: "Law",
        duration: "3 years",
        apsRequirement: 28,
        description: "Law with psychology specialization",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 4, isRequired: true },
        ],
      ...
      {
        id: createDegreeId("Bachelor of Arts Law Politics NWU"),
        name: "Bachelor of Arts in Law (BA in Law) (with Politics)",
        faculty: "Law",
        duration: "3 years",
        apsRequirement: 28,
        description: "Law with politics specialization",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "History", level: 3, isRequired: false },
        ],
      ...
      {
        id: createDegreeId("Bachelor of Arts Law Industrial Psychology NWU"),
        name: "Bachelor of Arts in Law (BA in Law) (with Industrial Psychology)",
        faculty: "Law",
        duration: "3 years",
        apsRequirement: 28,
        description: "Law with industrial psychology",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 4, isRequired: true },
        ],
      ...
      {
        id: createDegreeId("Bachelor of Commerce Law BCom Law NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Laws LLB NWU"),
      ...
      {
        id: createDegreeId("Extended Bachelor of Laws LLB NWU"),
  ...
  },
  {
    ...
    degrees: [
      ...
      {
        id: createDegreeId("Bachelor of Science Chemistry Physics NWU"),
        name: "Bachelor of Science (with Chemistry and Physics)",
        faculty: "Natural and Agricultural Sciences",
        duration: "3 years",
        apsRequirement: 26,
        description: "Science with chemistry and physics combination",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 5, isRequired: true },
          { name: "Physical Sciences", level: 5, isRequired: true },
      ...
      {
        id: createDegreeId("Bachelor of Science Physics Mathematics NWU"),
        name: "Bachelor of Science (with Physics and Mathematics)",
        faculty: "Natural and Agricultural Sciences",
        duration: "3 years",
        apsRequirement: 26,
        description: "Science with physics and mathematics",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 6, isRequired: true },
          { name: "Physical Sciences", level: 5, isRequired: true },
      ...
      {
        id: createDegreeId(
          "Bachelor of Science Computer Sciences Mathematics NWU",
        ),
      ...
      {
        id: createDegreeId("Bachelor of Science Information Technology NWU"),
      ...
      {
        id: createDegreeId(
          "Extended Bachelor of Science Information Technology NWU",
        ),
      ...
      {
        id: createDegreeId(
          "Bachelor of Science Mathematical Sciences Statistics Mathematics NWU",
        ),
        name: "Bachelor of Science in Mathematical Sciences (with Statistics and Mathematics)",
        faculty: "Natural and Agricultural Sciences",
        duration: "3 years",
        apsRequirement: 26,
        description: "Mathematical sciences with statistics focus",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 6, isRequired: true },
        ],
        careerProspects: ["Statistician", "Data Analyst", "Actuary"],
      },
      {
        id: createDegreeId(
          "Bachelor of Science Biological Sciences Microbiology Biochemistry NWU",
        ),
        name: "Bachelor of Science in Biological Sciences (with Microbiology and Biochemistry)",
        faculty: "Natural and Agricultural Sciences",
        duration: "3 years",
        apsRequirement: 26,
        description: "Biological sciences with microbiology and biochemistry",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 4, isRequired: true },
          { name: "Life Sciences", level: 5, isRequired: true },
        ],
        careerProspects: ["Microbiologist", "Biochemist", "Research Scientist"],
      },
      {
        id: createDegreeId(
          "Bachelor of Science Environmental Sciences Chemistry Geography NWU",
        ),
        name: "Bachelor of Science in Environmental Sciences (with Chemistry and Geography)",
        faculty: "Natural and Agricultural Sciences",
        duration: "3 years",
        apsRequirement: 26,
        description: "Environmental sciences with chemistry and geography",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 4, isRequired: true },
          { name: "Physical Sciences", level: 4, isRequired: true },
      ...
      {
        id: createDegreeId("Bachelor of Science Actuarial Science NWU"),
        name: "Bachelor of Science in Actuarial Science",
        faculty: "Natural and Agricultural Sciences",
        duration: "3 years",
        apsRequirement: 32,
        description: "Actuarial science and risk analysis",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Mathematics", level: 6, isRequired: true },
        ],
      ...
      {
        id: createDegreeId("Bachelor of Science Urban Regional Planning NWU"),
      ...
      {
        id: createDegreeId("Bachelor of Science Agricultural Sciences NWU"),
      ...
      {
        id: createDegreeId(
          "Bachelor of Science Indigenous Knowledge Systems NWU",
        ),
  ...
  },
  {
    ...
    description: "Theological studies and religious education programs",
    degrees: [
      {
      ...
      {
        id: createDegreeId("Bachelor of Divinity BDiv NWU"),
        name: "Bachelor of Divinity (BDiv)",
        faculty: "Theology",
        duration: "4 years",
        apsRequirement: 24,
        description: "Professional theology and ministry preparation",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Life Orientation", level: 3, isRequired: false },
        ],
      ...
      },
      {
        ...
        duration: "3 years",
        apsRequirement: 24,
        description: "Pastoral care with psychological principles",
        subjects: [
          { name: "English", level: 4, isRequired: true },
          { name: "Life Orientation", level: 3, isRequired: false },
        ],
