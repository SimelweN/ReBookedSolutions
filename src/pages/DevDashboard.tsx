...
const DevDashboard: React.FC = () => {
  ...
  if (isMobile) {
    return (
      <AdminMobileLayout title="Development Dashboard">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          Demo orders create test data with 48-hour deadlines.
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            try {
                              ...
                              toast.error(
                                "Commit stats function not available",
                              );
                            }
                          }}
                        >
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 p-3 md:p-6">
        <div className="max-w-7xl mx-auto space-y-4 md:space-y-6">
          {/* Desktop content would go here - for now, show mobile layout */}
          <AdminMobileLayout title="Development Dashboard">
            <div className="p-3 space-y-4">
              <div className="text-center py-8">
                <p className="text-gray-600">
                  Desktop view is being enhanced. Please use mobile view for
                  full functionality.
                </p>
              </div>
            </div>
