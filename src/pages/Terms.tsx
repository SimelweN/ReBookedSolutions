        ...
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent className="prose prose-book max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-book-700 mb-4">
                1. Acceptance of Terms
              </h2>
              <p className="mb-4">
                By accessing and using Rebooked Solutions ("the Service"), you
                accept and agree to be bound by the terms and provision of this
                agreement. This service is provided in{" "}
                <strong>South Africa</strong>, and is subject to South African
                law.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Permission is granted to temporarily use Rebooked Solutions for
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-medium text-book-600 mb-2">
                For Sellers:
              </h3>
              <ul className="list-disc list-inside mb-4 ml-4">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Rebooked Solutions charges a 10% commission on all successful
                sales. This fee covers:
              </p>
              <ul className="list-disc list-inside mb-4 ml-4">
              ...
              <p className="mb-4">
                All payments are processed securely through Paystack. We do not
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Shipping arrangements are made between buyers and sellers.
                Rebooked Solutions facilitates these transactions but is not
                responsible for:
              </p>
              <ul className="list-disc list-inside mb-4 ml-4">
              ...
              <p className="mb-4">
                Returns are handled on a case-by-case basis. Contact our support
                team within 48 hours of receiving an item if you have concerns.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                To the fullest extent permitted by law, Rebooked Solutions:
              </p>
              <ul className="list-disc list-inside mb-4 ml-4">
                <li>
                ...
                <li>
                  Does not guarantee the accuracy of listings or user-provided
                  information
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                In no event shall Rebooked Solutions or its suppliers be liable
                ...
                of the use or inability to use the materials on Rebooked
                Solutions's website.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Rebooked Solutions reserves the right to revise these terms of
            ...
            <section className="mb-8 bg-book-50 border border-book-200 rounded-lg p-6">
              <h2 className="text-2xl font-semibold text-book-700 mb-4">
                📜 Complete Legal Documentation
              </h2>
              <p className="mb-4">
                For our comprehensive Terms & Conditions, Refund Policy,
                Cancellation Policy, Shipping & Delivery Policy, and Returns &
                Disputes Policy - all in compliance with South African consumer
                protection laws - please visit:
              </p>
              <a
                href="/policies"
                className="inline-flex items-center bg-book-600 hover:bg-book-700 text-white px-6 py-3 rounded-lg font-medium transition-colors"
              >
                View Complete Policies & Terms →
              </a>
              <p className="text-sm text-gray-600 mt-3">
                Includes comprehensive coverage of consumer rights, dispute
                resolution, and all platform policies.
              </p>
            </section>
          </CardContent>
        </Card>
