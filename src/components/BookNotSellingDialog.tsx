...
const BookNotSellingDialog = ({
  isOpen,
  onClose,
}: BookNotSellingDialogProps) => {
  const tips = [
    {
      icon: <DollarSign className="h-5 w-5 text-green-600" />,
      title: "Competitive Pricing",
      description:
        "Check similar books and price yours competitively. Consider market demand.",
    },
    {
      icon: <Camera className="h-5 w-5 text-blue-600" />,
      title: "High-Quality Photos",
      description:
        "Upload clear, well-lit photos showing the book's condition from multiple angles.",
    },
    {
      icon: <MessageSquare className="h-5 w-5 text-purple-600" />,
      title: "Detailed Description",
      description:
        "Write a comprehensive description including condition, edition, and any notes.",
    },
    {
      icon: <Eye className="h-5 w-5 text-orange-600" />,
      title: "Book Visibility",
      description:
        "Share your listing on social media or with classmates who might need the book.",
    },
  ];
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-xl max-h-[85vh] overflow-y-auto sm:w-full">
        <DialogHeader>
          ...
          <DialogDescription>
            Follow these proven tips to increase your book's visibility and
            chances of selling.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-book-700 text-sm">
                  Books typically sell faster at the beginning and end of each
                  semester. Consider timing your listings accordingly for
                  maximum visibility.
                </p>
              </div>
            </div>
